...
export default function Board() {
  ...
  useEffect(() => {
    ...
    socketRef.current = io(import.meta.env.VITE_API_URL || "https://nbprosistem.onrender.com");
  ...
  const saveColumnNote = async (columnId, note) => {
    try {
      ...
      await axios.patch(`${import.meta.env.VITE_API_URL || "https://nbprosistem.onrender.com"}/api/column-notes/${columnId}`,
        { note },
